...
<div class="container marketing" style="background-color: #ffffff">
    ...
    <form role="form" action="/admin/dish/addNew" method="post">
        ...
        <div class="form-group">
            ...
            <input type="number" id="dishPrice" class="form-control" name="price" placeholder="Enter dish price"
                   required>
        </div>

        <div class="form-group">
            <label for="dishWeight">Dish weight</label>
            <input type="number" id="dishWeight" class="form-control" name="weight" placeholder="Enter dish weight, g."
                   required>
        </div>

        <div class="form-group">
            <label for="dishPhoto">Dish photo</label>
            <input type="text" id="dishPhoto" class="form-control" name="photoLink"
                   placeholder="Enter link to the photo, size must be 120*80 px">
        </div>
