...
<div class="container marketing" style="background-color: #ffffff">
    ...
    <div class="row" style="margin-top: 40px;">
        <c:forEach items="${employees}" var="employee">
            <div class="col-lg-4">
                <a href="/admin/employee/${employee.id}"><img class="img-circle" src="${employee.photoLink}"
                                                              alt="Employee photo"></a>
    ...
    <form role="form" action="/admin/employee/save" method="post">
        ...
        <button type="submit" class="btn btn-success"><img src="/resources/images/employee.png" width="32"> Add employee
        </button>
    </form>
</div>
<!-- /.container -->
