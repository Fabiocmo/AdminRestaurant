...
<div class="container marketing" style="background-color: #ffffff">
    ...
    <div class="row" style="margin-top: 40px;">
        ...
        <div class="col-lg-4" style="margin: 0 auto; float: none;">
            <img class="img-circle" style="float: none; margin: 0 auto; text-align: center;" src="${dish.photoLink}"
                 width="140" alt="${dish.name}">
            ...
            <ul class="list-inline">
                ...
                <c:forEach items="${dish.ingredients}" var="ingredient">
                    <li style="font-size: small; color: #e33539; font-family: OpenSans-Light, serif">
                        <strong>${ingredient.name}</strong></li>
                </c:forEach>
            </ul>
            </p>
