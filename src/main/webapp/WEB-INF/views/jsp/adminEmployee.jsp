...
<div class="container marketing" style="background-color: #ffffff">
    ...
    <div class="row" style="margin-top: 40px;">
        ...
        <div class="col-lg-4" style="margin: 0 auto; float: none;">
            <img class="img-circle" style="float: none; margin: 0 auto; text-align: center;" src="${employee.photoLink}"
                 width="140" alt="${employee.firstName}">

            <h2 class="text-center"
                style="color: #689f38;font-size: 30px;">${employee.firstName} ${employee.secondName}</h2>
                ...
                <ul class="list-inline">
                    ...
                    <c:forEach items="${employee.orderList}" var="order">
                        <a href="/admin/order/${order.id}">
                            <li style="font-size: small; color: #e33539; font-family: OpenSans-Light, serif"><strong>
                                Order number ${order.orderNumber} </strong></li>
                        </a>
                    </c:forEach>
                </ul>
                </p>
            ...
            <c:if test="${position eq 'COOK'}">
                ...
                <ul class="list-inline">
                    ...
                    <c:forEach items="${employee.readyMealList}" var="readyMeal">
                        <a href="/admin/dish/${readyMeal.dishId.id}">
                            <li style="font-size: small; color: #e33539; font-family: OpenSans-Light, serif"><strong>
                                Name: ${readyMeal.dishId.name} Order: ${readyMeal.orderId.orderNumber} </strong></li>
                        </a>
                    </c:forEach>
                </ul>
                </p>
