<%@ page import="com.gmail.liliyayalovchenko.domain.Position" %>
...
<div class="container marketing" style="background-color: #ffffff">
  <div class="row">
    <div class="col-lg-8" style="float: none; margin-left: auto; margin-right: auto;">
      <h1 class="text-center" style="margin-top: 0; font-family: 'Minion Pro'; font-size: 80px; color: #e33539 ;">${employee.firstName} ${employee.secondName}</h1>
    </div>
  </div>
  ...
  <form role="form" action="/admin/employee/save/${employee.id}" method="post">
    ...
    <div class="form-group">
      ...
      <input type="text" id="employeeSecondName" class="form-control" name="secondName" value="${employee.secondName}">
    </div>
